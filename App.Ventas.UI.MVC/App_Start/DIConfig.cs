...
namespace App.Ventas.UI.MVC.App_Start
{
    public class DIConfig
    {
        public static void ConfigureInjector()
        {
            ...
            container.Register<IUnitOfWork>(() => new VentasUnitOfWork(
                        ConfigurationManager.ConnectionStrings["VentasConnection"].ToString()));
